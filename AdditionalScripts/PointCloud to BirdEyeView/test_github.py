...
#   ax.add_patch(p)
  ...
  return np.array(bb2d), np.array(bb3d), corners_3D
...
def main ():
  ...
  for frame in ["000150", "000205", "000775", "000808", "000871", "001584", "001599", "001955", "002738", "003473", "003592", "007328"]:
      ...
      bb2d, bb3d, corners3d = labelToBoundingBox(ax, label_data, calib_data)
